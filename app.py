...
class Venue(db.Model):
    ...
    # past_shows_count = db.Column(db.Number)
    # upcoming_shows_count = db.Column(db.Number)
...
class Artist(db.Model):
    ...
    # upcoming_shows_count = db.Column(db.String(500))
...
def venues():
    ...
    venues = list(map(mapVenues, venues))
    venues = list(reduce(reduceVenues, venues, []))
    data = [{
        "city": "San Francisco",
        "state": "CA",
        "venues": [{
...
def create_venue_submission():
    ...
    venue.genres = json.dumps(formData['genres'])
    venue.facebook_link = formData['facebook_link']
    venue.website = formData['website_link']
    venue.seeking_talent = formData['seeking_talent']
...
def create_artist_submission():
    ...
    artist.genres = json.dumps(formData['genres'])
    artist.facebook_link = formData['facebook_link']
    artist.website = formData['website_link']
    artist.seeking_venue = formData['seeking_venue']
